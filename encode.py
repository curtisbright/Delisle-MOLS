...
A = [[0 for j in range(4*n)] for i in range(n*n)]
for i in range(n*n):
	for j in range(4*n):
		total_vars += 1
		A[i][j] = total_vars
...
LA = [[[0 for k in range(n)] for j in range(n)] for i in range(n)]
LB = [[[0 for k in range(n)] for j in range(n)] for i in range(n)]
LZ = [[[0 for k in range(n)] for j in range(n)] for i in range(n)]

for i in range(n):
	for j in range(n):
		for k in range(n):
			LA[i][j][k] = A[i*n+j][2*n+k]
			LB[i][j][k] = A[i*n+j][3*n+k]
			total_vars += 1
			LZ[i][j][k] = total_vars
...
for i in range(n):
	for j in range(n):
		generate_exactly_one_clauses([LA[i][j][k] for k in range(n)])
		generate_exactly_one_clauses([LA[i][k][j] for k in range(n)])
		generate_exactly_one_clauses([LA[k][i][j] for k in range(n)])
		generate_exactly_one_clauses([LB[i][j][k] for k in range(n)])
		generate_exactly_one_clauses([LB[i][k][j] for k in range(n)])
		generate_exactly_one_clauses([LB[k][i][j] for k in range(n)])
		generate_exactly_one_clauses([LZ[i][j][k] for k in range(n)])
		generate_exactly_one_clauses([LZ[i][k][j] for k in range(n)])
		generate_exactly_one_clauses([LZ[k][i][j] for k in range(n)])
